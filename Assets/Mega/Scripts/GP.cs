...
namespace Assets.Mega.Scripts {
    public class GP {
        ...
        public static bool fullUI = true;

        public static float btnBaseRotateSpeed = 2;
        public static float btnMaxRotateSpeed = 50;

        public static float btnBaseZoomSpeed = 50;
        public static float btnMaxZoomSpeed = 150;
